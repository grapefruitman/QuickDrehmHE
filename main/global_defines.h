...
#define RC_FLIGHT_CONFIG 5 // rename if you want channels to have mode names
#define RC_FLIGHT_MODE 6 // rename if you want channels to have mode names
...
// pin 0
#define SERVO_LEFT_AILERON 0 // rename to match what the servo does
// pin 1
#define SERVO_RIGHT_AILERON 1 // rename to match what the servo does
// pin 5
#define SERVO_LEFT_ELEVATOR 2 // rename to match what the servo does
// pin 6
#define SERVO_RIGHT_ELEVATOR 3 // rename to match what the servo does
// pin 10
